...
public class TestReportProcessor {
	...
	public static void main(String[] args) throws Exception {
		...
		processor.write(testReportsDir, new CssRagStatus(cssRed, cssAmber, cssGreen),
	...
	public void write(File testReportsDir, CssRagStatus cssRagStatus, List<TestRunResults> runResults)
			throws TestReporterError {
